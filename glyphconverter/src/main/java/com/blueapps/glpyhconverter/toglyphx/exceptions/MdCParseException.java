...
public class MdCParseException extends RuntimeException {
    ...
    public static final String ILLEGAL_ID_CHARACTER_COUNT = "Illegal Id Character Count Exception: The char '%c' can only be used twice in an id, but was used %d times: \"%s\"";
    public static final String ILLEGAL_CHARACTER_COMBINATION = "Illegal Character Combination Exception: The chars '%c' and '%c' can't be used together directly after each other: \"%s\"";
    public static final String ILLEGAL_ALPHA_NUMERIC_COMBINATION = "Illegal Alpha Numeric Combination Exception: The char '%c' can not be used together with an id: \"%s\"";
